 ...
 */
ICACHE_FLASH_ATTR static inline void gpio_disable(const uint8_t gpio_num)
{
 ...
 * give it a try)
 */
ICACHE_FLASH_ATTR static inline void gpio_set_output_on_sleep(const uint8_t gpio_num, bool enabled)
{
    if (enabled) {
 ...
 */
ICACHE_FLASH_ATTR static inline void gpio_write(const uint8_t gpio_num, const bool set)
{
    if (gpio_num == 16) {
 ...
 */
ICACHE_FLASH_ATTR static inline void gpio_toggle(const uint8_t gpio_num)
{
 ...
 * GPIO_INPUT.
 */
ICACHE_FLASH_ATTR static inline bool gpio_read(const uint8_t gpio_num)
{
    if (gpio_num == 16)
...
ICACHE_FLASH_ATTR static inline gpio_inttype_t gpio_get_interrupt(const uint8_t gpio_num)
{
 ...
 */
ICACHE_FLASH_ATTR inline static void gpio_set_iomux_function(const uint8_t gpio_num, uint32_t func)
{
