...
const char * M_MOUNTED_OK = "успешно смонтирована";
const char * M_REMOUNTED_OK = "отформатирована заново";
const char * M_FORMATTED_BUT_FAIL = "отформатирована, но не смонтирована";
const char * M_FORMAT_FAILED = "не получилось отформатировать";

extern spiffs fs;

void spiffs_init()
{
    esp_spiffs_init(0x200000,0x200000);
